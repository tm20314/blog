...
つもログの現在の構成とAstro MCP設定・検証手順は [サイト保守ガイド](docs/astro-ai-maintenance.md) を参照してください。
...
5. The production site is deployed on Cloudflare Pages at `https://tumolog.com`. Pushes to `main` trigger the production deployment.
